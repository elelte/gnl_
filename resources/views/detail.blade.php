        ...
        <article class="column large-full entry format-standard">
            ...
            <div class="media-wrap entry__media">
                <div class="entry__post-thumb">
                    <img src="{{ asset('typerite/images/thumbs/single/standard/standard-1000.jpg') }}" 
                            srcset="{{ asset('typerite/images/thumbs/single/standard/standard-2000.jpg') }} 2000w, 
                                    {{ asset('typerite/images/thumbs/single/standard/standard-1000.jpg') }} 1000w, 
                                    {{ asset('typerite/images/thumbs/single/standard/standard-500.jpg') }} 500w" sizes="(max-width: 2000px) 100vw, 2000px" alt="">
                </div>
            </div>
            ...
            <div class="entry__content">
                ...
                Test ex ad cupidatat tempor Excepteur cillum cupidatat 
